...
$_this.find('.count_time').on('time.elapsed',function(ev, ms){
 ...
 };						cb.bind($('section[data-section-id="LkK2y7Jpwd"]').get(0))(jQuery);};					cb.bind($('section[data-section-id="LkK2y7Jpwd"]').get(0))({						url: "https://library.layouthub.com/HUB/files/RmViLS0yMDIx/NjEzNzA2NjU3/release-2-2021/pages/9Mr4wymCTgDPN1VJ/product/",						settings: {"use_zoom":"yes","days":"DAYS","hours":"HOURS","mins":"MINS","secs":"SECONDS","trans_unavai":"Unavailable","trans_instock":"In stock","trans_outstock":"Out of stock"}					}, jQuery);})(jQuery);;(function($){var ajax = (p, c, e) => { $.ajax({url: window.location.href, method: "POST",							data: $.extend(true, p !== undefined && typeof p == "object" ? p : {}, {								action: "layouthub_section_ajax", section_id: "BE1FHmQ9JI"							}), success: c, error: e});						}, cb  = function(section, $) {};					cb.bind($('section[data-section-id="BE1FHmQ9JI"]').get(0))({						url: "https://library.layouthub.com/HUB/files/RmViLS0yMDIx/NjEzNzA2NjU3/release-2-2021/pages/9Mr4wymCTgDPN1VJ/review/",						settings: {}					}, jQuery);})(jQuery);;(function($){var ajax = (p, c, e) => { $.ajax({url: window.location.href, method: "POST",							data: $.extend(true, p !== undefined && typeof p == "object" ? p : {}, {								action: "layouthub_section_ajax", section_id: "sNdSUfc024"							}), success: c, error: e});						}, cb  = function(section, $) {;var cb  = function($) {
		var $this = jQuery(this);
		var slide = new Swiper($this.find('.swiper-container')[0], {
			speed : 500,
      breakpointsInverse : true,
      watchSlidesVisibility : true,
      grabCursor : true,
      watchOverflow : true,
		  slidesPerView: section.settings.show_2 == 'yes' ? 2 : 1,
			spaceBetween: 15,
		  navigation: {
		      nextEl: $this.find('.lh-slide-nav .swiper-button-next')[0],
		      prevEl: $this.find('.lh-slide-nav .swiper-button-prev')[0]
		  },
			breakpoints: {
		    576: {
		      slidesPerView: 2,
		...
		initRating();
 };						cb.bind($('section[data-section-id="sNdSUfc024"] include[data-name="product-grid"][data-id="1"]').get(0))(jQuery);;var cb  = function($) {
  if(document.querySelector('.page-container') && window.getComputedStyle(document.querySelector('.page-container')).transform.indexOf('matrix') != -1){
    document.querySelector('.page-container').style.webkitTransform='none';
    document.querySelector('.page-container').style.transform='none';
  }
 };						cb.bind($('section[data-section-id="sNdSUfc024"]').get(0))(jQuery);};					cb.bind($('section[data-section-id="sNdSUfc024"]').get(0))({						url: "https://library.layouthub.com/HUB/files/RmViLS0yMDIx/NjEzNzA2NjU3/release-2-2021/pages/9Mr4wymCTgDPN1VJ/o-product/",						settings: {"show_2":"no"}					}, jQuery);})(jQuery);;(function($){var ajax = (p, c, e) => { $.ajax({url: window.location.href, method: "POST",							data: $.extend(true, p !== undefined && typeof p == "object" ? p : {}, {								action: "layouthub_section_ajax", section_id: "y0JUI9FgpT"							}), success: c, error: e});						}, cb  = function(section, $) {;var cb  = function($) {
  let _this = jQuery(this);
  let content = _this.find('.lh-contents');
  (section.settings.style != '3') && _this.find('.lh-item').each(function(){
    let _ = jQuery(this);
    _.find('button').click(function(){
      if(content.hasClass('lh-loading')) return;
      content.addClass('lh-loading');
      _.toggleClass('active');
      _.find('.lh-item__content').slideToggle(200, function(){
        content.removeClass('lh-loading');
      });
      if(section.settings.style == '2'){
        //let sib = _.siblings('.active');
        let sib = content.find('.lh-item.active').not(_);
        sib.removeClass('active');
        sib.find('.lh-item__content').slideUp(200);
      }
    });
  });
 };						cb.bind($('section[data-section-id="y0JUI9FgpT"] include[data-name="content"][data-id="1"]').get(0))(jQuery);};					cb.bind($('section[data-section-id="y0JUI9FgpT"]').get(0))({						url: "https://library.layouthub.com/HUB/files/RmViLS0yMDIx/NjEzNzA2NjU3/release-2-2021/pages/9Mr4wymCTgDPN1VJ/faq-1/",						settings: {"style":"1"}					}, jQuery);})(jQuery);;(function($){var ajax = (p, c, e) => { $.ajax({url: window.location.href, method: "POST",							data: $.extend(true, p !== undefined && typeof p == "object" ? p : {}, {								action: "layouthub_section_ajax", section_id: "gn8olnxykru"							}), success: c, error: e});						}, cb  = function(section, $) {window.HUB = window.HUB || {};
...
window.HUB.formatMoney = window.HUB.formatMoney ||  function(t, r) {
    ...
    $this.on('click', '.lh-sorting-btn,.lh-overlay',function(){
        $this.find('.shopify-ordering').toggleClass('active');
    });
    var queryParams = {};
    //onClickTag();
    ...
    var swiper = new Swiper($this.find('.lh-collection-content')[0], data);
...
initAll();
 ...
 };						cb.bind($('section[data-section-id="gn8olnxykru"] include[data-name="product-items"][data-id="1"]').get(0))(jQuery);;var cb  = function($) {
  if(document.querySelector('.page-container') && window.getComputedStyle(document.querySelector('.page-container')).transform.indexOf('matrix') != -1){
    document.querySelector('.page-container').style.webkitTransform='none';
    document.querySelector('.page-container').style.transform='none';
  }
   var  _this = jQuery(this),
      ...
      popup_sidebar = _this.find('.lh-popup-sidebar');
  $(window).resize(function(){
    if($(window).width() >= 992) {
      _dom.hasClass('lh-mobile') && _dom.removeClass('lh-mobile');
      _dom.hasClass('lh-show') && _dom.removeClass('lh-show');
    }
    else
      !_dom.hasClass('lh-mobile') && _dom.addClass('lh-mobile');
  }).trigger('resize');
  popup_sidebar.click(function(e){
    e.preventDefault();
    _dom.toggleClass('lh-show');
  });
  _dom.find('.lh-sidebar-close a , .lh-sidebar-overlay').click(function(){
    _dom.removeClass('lh-show');
  })
  initRating();
  function initRating(){
  ...
  var ColumnSwitcher  = (function(){
    var key_col   = 'lh-col-switcher';
    var $switcher = _dom.find('.lh-col-switcher'),
        $main     = _dom.find('.lh-main-collection');
    function getData(){
      return window.localStorage.getItem(key_col) || 'grid';
    }
    function setData(col){
      window.localStorage.setItem(key_col,col);
    }
    function setColumn(col){
      $main.attr('data-col', col);
      $switcher.find('.lh-grid-' + col).addClass('active')
 ...
 };						cb.bind($('section[data-section-id="gn8olnxykru"]').get(0))(jQuery);};					cb.bind($('section[data-section-id="gn8olnxykru"]').get(0))({						url: "https://library.layouthub.com/HUB/files/TWFyLS0yMDIx/NjE1Mjc3MDI3/release-3-2021/pages/dYquXFtvam68ni4E/collection/",						settings: {"image_size":"270x360_crop_center","label_soldout":"Sold out","loop":"no","auto":"no","time":"3"}					}, jQuery);})(jQuery);;(function($){var ajax = (p, c, e) => { $.ajax({url: window.location.href, method: "POST",							data: $.extend(true, p !== undefined && typeof p == "object" ? p : {}, {								action: "layouthub_section_ajax", section_id: "9rc1zo3qjy9"							}), success: c, error: e});						}, cb  = function(section, $) {window.HUB = window.HUB || {};
...
initAll();
 ...
 };						cb.bind($('section[data-section-id="9rc1zo3qjy9"] include[data-name="product-items"][data-id="1"]').get(0))(jQuery);;var cb  = function($) {
  if(document.querySelector('.page-container') && window.getComputedStyle(document.querySelector('.page-container')).transform.indexOf('matrix') != -1){
    document.querySelector('.page-container').style.webkitTransform='none';
    document.querySelector('.page-container').style.transform='none';
  }
 ...
 };						cb.bind($('section[data-section-id="9rc1zo3qjy9"]').get(0))(jQuery);};					cb.bind($('section[data-section-id="9rc1zo3qjy9"]').get(0))({						url: "https://library.layouthub.com/HUB/files/TWFyLS0yMDIx/NjE1Mjc3MDI3/release-3-2021/pages/dYquXFtvam68ni4E/collection/",						settings: {"image_size":"270x360_crop_center","label_soldout":"Sold out","loop":"no","auto":"no","time":"3"}					}, jQuery);})(jQuery);;(function($){var ajax = (p, c, e) => { $.ajax({url: window.location.href, method: "POST",							data: $.extend(true, p !== undefined && typeof p == "object" ? p : {}, {								action: "layouthub_section_ajax", section_id: "sp7o08jw2wt"							}), success: c, error: e});						}, cb  = function(section, $) {// Generated by CoffeeScript 1.9.3
(function() {
  var Instafeed;
...
var $this = jQuery(this),
    el_user = $this.find('.lh-btn-user'),
    limit   = 5,
    token = section.settings.instagram,
    index = 0,
    html = '',
    ...
    {
      jQuery.get('https://graph.instagram.com/me/media',{fields: 'id,caption,media_url,thumbnail_url,media_type,permalink,username,comments_count,like_count', access_token: token,limit  })
      .then((response)=>{
    ...
    function renderDom(data)
    {
      var html = data.map((item)=>{
          el_user.attr("href" , "https://www.instagram.com/" + item.username);
          el_user.attr("title" , item.username);
          el_user.text('#'+item.username);
       let dom  =  '<div class="lh-item' + ((item.media_type == "VIDEO") ? ' lh-video' : '') + '">';
                     dom +=  (window.LAYOUTHUB_LIVE || window.location.protocol == "blob:") ? `<a class="lh-effect-ani1" href="${item.permalink}" style="background: url('${(item.media_type == "VIDEO") ? item.thumbnail_url : item.media_url}') center center / cover no-repeat scroll rgb(255, 255, 255);"></a></div>` :
                                                     `<a class="lh-effect-ani1" href="${item.permalink}" data-lh-bg="${(item.media_type == "VIDEO") ? item.thumbnail_url : item.media_url}" style="background: url('data:image/gif;base64,iVBORw0KGgoAAAANSUhEUgAAAAEAAAABCAQAAAC1HAwCAAAAC0lEQVR42mNkYAAAAAYAAjCB0C8AAAAASUVORK5CYII=') center center / cover no-repeat scroll rgb(255, 255, 255);"></a></div>`;
          return dom;
        });

        html.forEach(function(item, i) {
          var _this = $this.find(`.lh-wrap-${i + 1}`);
          _this.html(html[i])
        });
    }
 };						cb.bind($('section[data-section-id="sp7o08jw2wt"] include[data-name="instagram"][data-id="1"]').get(0))(jQuery);};					cb.bind($('section[data-section-id="sp7o08jw2wt"]').get(0))({						url: "https://library.layouthub.com/HUB/files/Tm92LS0yMDE5/NTc0ODY0ODc5/First_release/pages/Deru/instagram/",						settings: {"instagram":""}					}, jQuery);})(jQuery);;(function($){var ajax = (p, c, e) => { $.ajax({url: window.location.href, method: "POST",							data: $.extend(true, p !== undefined && typeof p == "object" ? p : {}, {								action: "layouthub_section_ajax", section_id: "qp46lashc2"							}), success: c, error: e});						}, cb  = function(section, $) {};					cb.bind($('section[data-section-id="qp46lashc2"]').get(0))({						url: "https://library.layouthub.com/HUB/files/TWFyLS0yMDIx/NjE1Mjc3MDI3/release-3-2021/pages/dYquXFtvam68ni4E/section/",						settings: {}					}, jQuery);})(jQuery);;console.log('This page layout has been built by https://www.layouthub.com');